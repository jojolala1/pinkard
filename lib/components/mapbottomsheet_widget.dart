                ...
                child: Padding(
                  ...
                  child: AuthUserStreamWidget(
                    builder: (context) => TextFormField(
                      controller: _model.mapsController,
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: _model.mapsController!.text.isNotEmpty
                            ? InkWell(
                                onTap: () async {
                                  _model.mapsController?.clear();
                                  setState(() {});
                                },
                                child: Icon(
                                  Icons.clear,
                      ...
                      maxLines: null,
                      validator:
                          _model.mapsControllerValidator.asValidator(context),
                    ),
                  ),
                ),
              ),
            ...
            child: FFButtonWidget(
              onPressed: () async {
                final usersUpdateData = createUsersRecordData(
                  maps: _model.mapsController.text,
                );
