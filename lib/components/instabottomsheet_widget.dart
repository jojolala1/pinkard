...
import 'instabottomsheet_model.dart';
export 'instabottomsheet_model.dart';

class InstabottomsheetWidget extends StatefulWidget {
  const InstabottomsheetWidget({Key? key}) : super(key: key);

  @override
  _InstabottomsheetWidgetState createState() => _InstabottomsheetWidgetState();
}

class _InstabottomsheetWidgetState extends State<InstabottomsheetWidget> {
  late InstabottomsheetModel _model;
