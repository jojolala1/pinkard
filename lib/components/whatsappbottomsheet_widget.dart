...
import 'whatsappbottomsheet_model.dart';
export 'whatsappbottomsheet_model.dart';

class WhatsappbottomsheetWidget extends StatefulWidget {
  const WhatsappbottomsheetWidget({Key? key}) : super(key: key);

  @override
  _WhatsappbottomsheetWidgetState createState() =>
      _WhatsappbottomsheetWidgetState();
}

class _WhatsappbottomsheetWidgetState extends State<WhatsappbottomsheetWidget> {
  late WhatsappbottomsheetModel _model;
