...
import 'menubottomsheet_model.dart';
export 'menubottomsheet_model.dart';
                  ...
                  child: AuthUserStreamWidget(
                    builder: (context) => TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: valueOrDefault(currentUserDocument?.menu, ''),
                        ...
                        suffixIcon: _model.menuController!.text.isNotEmpty
                            ? InkWell(
                                onTap: () async {
                                  _model.menuController?.clear();
                                  setState(() {});
                                },
                                child: Icon(
                                  Icons.clear,
                      ...
                      maxLines: null,
                      validator:
                          _model.menuControllerValidator.asValidator(context),
                    ),
                  ),
                ),
              ),
