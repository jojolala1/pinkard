...
import 'youtubebottomsheet_model.dart';
export 'youtubebottomsheet_model.dart';

class YoutubebottomsheetWidget extends StatefulWidget {
  const YoutubebottomsheetWidget({Key? key}) : super(key: key);

  @override
  _YoutubebottomsheetWidgetState createState() =>
      _YoutubebottomsheetWidgetState();
}

class _YoutubebottomsheetWidgetState extends State<YoutubebottomsheetWidget> {
  late YoutubebottomsheetModel _model;
