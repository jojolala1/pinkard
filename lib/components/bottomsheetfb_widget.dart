...
import 'bottomsheetfb_model.dart';
export 'bottomsheetfb_model.dart';

class BottomsheetfbWidget extends StatefulWidget {
  const BottomsheetfbWidget({Key? key}) : super(key: key);

  @override
  _BottomsheetfbWidgetState createState() => _BottomsheetfbWidgetState();
}

class _BottomsheetfbWidgetState extends State<BottomsheetfbWidget> {
  late BottomsheetfbModel _model;
