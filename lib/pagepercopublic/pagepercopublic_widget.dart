                    ...
                    child: SingleChildScrollView(
                      child: Column(
                        ...
                        children: [
                          ...
                          if ('${pagepercopublicUsersRecord.menu}${pagepercopublicUsersRecord.site}${pagepercopublicUsersRecord.contact}${pagepercopublicUsersRecord.airbnb}${pagepercopublicUsersRecord.booking}${pagepercopublicUsersRecord.tripadvisor}${pagepercopublicUsersRecord.maps}' !=
                                  null &&
                              '${pagepercopublicUsersRecord.menu}${pagepercopublicUsersRecord.site}${pagepercopublicUsersRecord.contact}${pagepercopublicUsersRecord.airbnb}${pagepercopublicUsersRecord.booking}${pagepercopublicUsersRecord.tripadvisor}${pagepercopublicUsersRecord.maps}' !=
                                  '')
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 40.0, 0.0, 0.0),
                          ...
                          if ('${pagepercopublicUsersRecord.instagram}${pagepercopublicUsersRecord.facebook}${pagepercopublicUsersRecord.snapchat}${pagepercopublicUsersRecord.tiktok}${pagepercopublicUsersRecord.messenger}${pagepercopublicUsersRecord.linkdln}${pagepercopublicUsersRecord.twitter}${pagepercopublicUsersRecord.pinterest}${pagepercopublicUsersRecord.youtube}${pagepercopublicUsersRecord.twich}' !=
                                  null &&
                          ...
                          if ('${pagepercopublicUsersRecord.phone}${pagepercopublicUsersRecord.phonesms}${pagepercopublicUsersRecord.email}${pagepercopublicUsersRecord.whatsapp}${pagepercopublicUsersRecord.zoom}${pagepercopublicUsersRecord.telegram}${pagepercopublicUsersRecord.discord}${pagepercopublicUsersRecord.skype}' !=
                                  null &&
                              '${pagepercopublicUsersRecord.phone}${pagepercopublicUsersRecord.phonesms}${pagepercopublicUsersRecord.email}${pagepercopublicUsersRecord.whatsapp}${pagepercopublicUsersRecord.zoom}${pagepercopublicUsersRecord.telegram}${pagepercopublicUsersRecord.discord}${pagepercopublicUsersRecord.skype}' !=
                                  '')
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 40.0, 0.0, 0.0),
